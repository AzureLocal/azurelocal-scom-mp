...
<#
.SYNOPSIS
    Verifies generated Azure Local Management Packs with the Microsoft Operations Manager SDK.
...
.PARAMETER InputPath
    Directory containing the generated Azure Local Management Pack XML files.
...
Write-Output "Microsoft SDK verification passed for $($verified.Count) Azure Local Management Pack artifact(s)."
