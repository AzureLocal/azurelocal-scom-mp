...
| **Network ATC overview for Windows Server** ⭐ | https://learn.microsoft.com/en-us/azure/azure-local/concepts/network-atc-overview | Network ATC applies consistent host-network intent to Windows Server 2025 Datacenter failover clusters as well as Azure Local. |
| Deploy host networking with Network ATC | https://learn.microsoft.com/en-us/windows-server/networking/network-atc/network-atc | Windows Server 2025 and Azure Local requirements, best practices, intent types, deployment, and event-log guidance. |
| Manage Network ATC | https://learn.microsoft.com/en-us/windows-server/networking/network-atc/manage-network-atc | Intent status, remediation, overrides, live-migration settings, and post-deployment operations. |
| Deploy and manage SDN in SCVMM | https://learn.microsoft.com/en-us/system-center/vmm/deploy-sdn?view=sc-vmm-2025 | SCVMM-managed Network Controller, virtual-network, policy, load-balancer, and gateway path. |
...
| **Microsoft System Center 2019 MP for Hyper-V** ⭐ | https://www.microsoft.com/en-us/download/details.aspx?id=101312 | Version 11.0.4.0, published July 2024; research source for useful topology, signal, monitor, threshold, and knowledge ideas only. The new MP will not depend on, import, extend, or override it. |
...
| **Authoring workspace and Distributed Applications (SCOM 2025)** ⭐ | https://learn.microsoft.com/en-us/system-center/scom/manage-using-authoring-workspace?view=sc-om-2025 | Current Operations Manager guidance: DA component grouping and calculated application health for alerts, views, and reports. |
| **Service-level objectives (SCOM 2025)** ⭐ | https://learn.microsoft.com/en-us/system-center/scom/manage-monitor-sla-overview?view=sc-om-2025 | Current SLO targeting and reporting guidance, including Distributed Application targets. |
